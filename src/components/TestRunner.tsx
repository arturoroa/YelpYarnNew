...
const TestRunner: React.FC<TestRunnerProps> = ({ onViewUserDetails }) => {
  ...
  const createUser = async () => {
    if (!newUser.firstName || !newUser.lastName || !newUser.email || !newUser.password || !newUser.confirmPassword || !newUser.zipCode || !newUser.birthday) {
    ...
    try {
      ...
      const createdDbUser = result.user;
      ...
      setNewUser({ firstName: '', lastName: '', email: '', password: '', confirmPassword: '', zipCode: '', birthday: '' });
    } catch (error) {
      setUserCreationStatus({
        loading: false,
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-gray-600">Enter user details manually and bot will create account on Yelp</p>
                    </div>
                  </div>
                </button>
            ...
            {userCreationMode === 'manual' && (
              <>
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    onClick={createUser}
                    disabled={userCreationStatus.loading || !passwordsMatch || !newUser.firstName || !newUser.lastName || !newUser.email || !newUser.password || !newUser.confirmPassword || !newUser.zipCode || !newUser.birthday}
